                    ...
                    <div class="bg-blue-50 rounded-lg p-4 space-y-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-foreground mb-3">Para validar sua participação no programa, é necessária o pagamento único de <span class="font-bold text-[#1B4F9B]">R$ 42,58</span>.</p>
...
$(document).on('click', '#btnAgendar', function(){
    window.location.href = "<?php echo e(url('/agendar-exame')); ?>";
});

</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/areadev.site/public_html/cnhsocial/resources/views/aprovado.blade.php ENDPATH**/ ?>