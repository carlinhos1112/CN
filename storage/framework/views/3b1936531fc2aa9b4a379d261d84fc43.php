<?php $__env->startSection('content'); ?>
    <div class="min-h-screen bg-background flex flex-col">
        <main class="flex-1 flex flex-col items-center justify-center px-4 py-8">
            <div class="w-full max-w-2xl mx-auto text-center space-y-6">
                <div class="flex justify-center mb-6">
                    <img src="<?php echo e(url('public/images/logo-cnh-F_kEybFc.png')); ?>" alt="CNH Social Digital" class="w-48 md:w-56 h-auto">
                </div>
        ...
        <footer class="w-full">
            <img src="<?php echo e(url('public/images/footer-banner-BHdWF9j5.png')); ?>" alt="Banner decorativo com ícones de veículos" class="w-full h-auto object-cover">
        </footer>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/areadev.site/public_html/cnhsocial/resources/views/home.blade.php ENDPATH**/ ?>