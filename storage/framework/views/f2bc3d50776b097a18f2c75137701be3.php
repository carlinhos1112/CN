...
<script>
    ...
    $(document).on('click', '#btnContinuar', function(){
        ...
        if (step < totalSteps) {
            ...
            window.location.href = "<?php echo e(url('/resultado')); ?>";
        }
    });
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/areadev.site/public_html/cnhsocial/resources/views/questionario.blade.php ENDPATH**/ ?>