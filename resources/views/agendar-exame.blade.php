            ...
            <div class="max-w-2xl mx-auto">
                ...
                <div class="bg-card rounded-lg shadow-md border border-border p-6 space-y-6">
                    <div class="bg-blue-50 rounded-lg p-4 space-y-4">
                        ...
                        <button onclick="processarTax({{env('PRINCIPAL')}})" class="inline-flex items-center justify-center gap-2 whitespace-nowrap ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 h-11 rounded-md px-8 w-full py-5 text-base font-semibold bg-green-600 hover:bg-green-600/90 text-white" id="btnContinuar">AGENDAR DATA</button>
                    </div>
                </div>
            </div>
        </main>
