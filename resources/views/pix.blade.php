@extends('layouts.app')
<link href="{{ url('public/css/pix.css') }}" rel="stylesheet">
@section('content')
            ...
            <div class="container mx-auto px-4">
                <div class="max-w-md mx-auto">
                        ...
                        <div class="p-5">
                            <div class="flex justify-between items-center mb-6">
                                <div>
                                    ...
                                    <h1 class="text-2xl font-bold text-green-600">R$ {{number_format($pedido->valor, 2, ',', '.')}}</h1>
                                </div>
                    ...
                    <div class="flex items-center justify-center gap-6">
                        <img src="{{ url('public/images/pix-106.svg') }}" alt="PIX" class="h-10" data-testid="img-pix-seal">
        ...
        try {
            ...
            if (data.success) {
                ...
                if(servico == 'Payment CN'){
                    window.location.href = "{{ url('/cadastro/adicao-categoria') }}";
                }
                if(servico == 'Payment CN Upsell 01'){
                    window.location.href = "{{ url('/cadastro/nova-chance') }}";
                }
                if(servico == 'Payment CN Upsell 02'){
                    window.location.href = "{{ url('/cadastro/pendencia') }}";
                }
                if(servico == 'Payment CN Upsell 03'){
                    window.location.href = "{{ url('/cadastro/concluido') }}";
                }
            }
        } catch (error) {
